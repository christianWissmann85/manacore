...
**When to use:**
- You need to trace *exactly* what happened turn-by-turn.
...
3.  **Isolate Logic**: Use `test-combat-debug.ts` or `test-greedy-debug.ts` to understand *why* the AI made the move that caused the issue.
