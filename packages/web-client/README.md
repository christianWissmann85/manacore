...
This is a fantastic pivot. By framing the Web Client as a **"Glass-Box AI Lab"** rather than just a game, we align perfectly with the academic and open-source goals of Manacore. It becomes a showcase of _intelligence_, not just mechanics.
...
- **Meaning:** "The Neural Network is paying 90% attention to _Counterspell_ right now." (Derived from attention weights or policy output distribution).
